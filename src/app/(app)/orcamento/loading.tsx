export default function OrcamentoLoading() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-4 animate-pulse">
      ...
      {/* Resumo */}
      <div className="bg-surface rounded-2xl border border-brand-700/10 p-5">
      ...
      {/* Categorias */}
      <div className="bg-surface rounded-2xl border border-brand-700/10 divide-y divide-brand-700/5">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="px-5 py-4 space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-full bg-brand-700/10" />
                <div className="h-3.5 w-28 bg-brand-700/20 rounded" />
              </div>
              <div className="text-right space-y-1">
                <div className="h-3 w-20 bg-brand-700/20 rounded ml-auto" />
                <div className="h-2.5 w-14 bg-brand-700/10 rounded ml-auto" />
              </div>
            </div>
