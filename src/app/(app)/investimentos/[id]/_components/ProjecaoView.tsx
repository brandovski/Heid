    ...
    <div className="space-y-3">
      ...
      <div className="bg-surface border border-brand-700/20 rounded-xl p-4">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-semibold text-brand-700">Projeção de Saldo</h2>
        ...
        <p className="text-xs text-brand-700/50 mb-3">
          Saldo hoje: <strong className="text-brand-700">{formatCurrency(saldoAtual)}</strong>
        </p>
      ...
      {itemsWithoutDate.length > 0 && (
        <div className="bg-surface border border-brand-700/20 rounded-xl p-4">
          <h2 className="text-sm font-semibold text-brand-700 mb-3">Comprometido sem data prevista</h2>
