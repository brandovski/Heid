  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-sm text-brand-700/50">Investimento: <strong>{investmentName}</strong></p>
        ...
        <div>
          <label className="block text-sm font-medium text-brand-700 mb-1">Valor (R$) *</label>
          <input
            type="number"
            value={amount}
