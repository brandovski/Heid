  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-brand-700 mb-1">Orçamento Total (R$) *</label>
          <input
            type="number"
            value={totalBudget}
        ...
        <div>
          <label className="block text-sm font-medium text-brand-700 mb-1">Data Alvo</label>
              ...
              <button
                ...
                className={`flex-1 py-2 text-sm font-medium rounded-lg border transition-colors ${
                  scope === s
                    ...
                    : "bg-surface text-brand-700 border-brand-700/30 hover:border-brand-700/40"
                }`}
              >
